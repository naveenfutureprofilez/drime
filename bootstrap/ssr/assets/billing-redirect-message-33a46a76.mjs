...
import { aP as useAuth, bd as useIsDarkMode, ba as useSelectedLocale, u as useSettings, a as apiClient, B as Button, q as Skeleton, p as opacityAnimation, E as ErrorIcon, T as Trans } from "../server-entry.mjs";
...
function BillingRedirectMessage({ config }) {
  return /* @__PURE__ */ jsx(AnimatePresence, { initial: false, mode: "wait", children: /* @__PURE__ */ jsx("div", { className: "mt-80", children: config ? /* @__PURE__ */ jsxs(
    m.div,
    {
      ...
      ...opacityAnimation,
      children: [
        config.status === "success" ? /* @__PURE__ */ jsx(TaskAltIcon, { className: "text-6xl text-positive" }) : /* @__PURE__ */ jsx(ErrorIcon, { className: "text-6xl text-danger" }),
        /* @__PURE__ */ jsx("div", { className: "mt-30 text-2xl font-semibold", children: /* @__PURE__ */ jsx(Trans, { ...config.message }) }),
        /* @__PURE__ */ jsx(
          Button,
          {
            variant: "flat",
  ...
  return /* @__PURE__ */ jsxs(
    m.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(Skeleton, { className: "mt-30 text-2xl" }),
...
//# sourceMappingURL=billing-redirect-message-33a46a76.mjs.map
