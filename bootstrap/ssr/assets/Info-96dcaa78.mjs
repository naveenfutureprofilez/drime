...
import { b5 as useMediaQuery, aO as getFromLocalStorage, s as setInLocalStorage, b8 as Underlay, f as createSvgIcon, aQ as Navbar, e as IconButton, ae as getBootstrapData, b9 as useUserTimezone, m as message, V as getInputFieldClassNames, an as useField, ao as Field, c as useIsMobileMediaQuery, ba as useSelectedLocale, bb as useDateFormatter, K as KeyboardArrowLeftIcon, u as useSettings, ak as DateFormatPresets, b3 as shallowEqual, a0 as List, a1 as ListItem, T as Trans, bc as useAutoFocus, g as useDialogContext, H as DialogFooter, B as Button, D as Dialog, i as DialogBody, k as DialogTrigger, bd as useIsDarkMode, X as createEventHandler, q as Skeleton, j as Checkbox, l as useTrans, a3 as FormSelect, I as Item, be as AvatarPlaceholderIcon, R as Tooltip, a as apiClient, S as SelectForwardRef, p as opacityAnimation, L as FormTextField, M as Chip, bf as useListbox, bg as Listbox, bh as Popover, a8 as ProgressCircle, aC as KeyboardArrowDownIcon, bi as useListboxKeyboardNavigation, h as DialogHeader, F as Form, d as useNumberFormatter, O as CloseIcon, aV as UploadedFile, bj as isAbsoluteUrl, aw as FileTypeIcon } from "../server-entry.mjs";
...
import { E as EditIcon, C as ChevronRightIcon } from "./Edit-7c480404.mjs";
...
function CalendarMonth({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "w-280 flex-shrink-0", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "block", role: "grid", children: [
      ...
      [...new Array(weeksInMonth).keys()].map((weekIndex) => /* @__PURE__ */ jsx(m.div, { className: "mb-6 flex", children: [...new Array(7).keys()].map((dayIndex) => /* @__PURE__ */ jsx(
        CalendarCell,
        {
...
function CalendarMonthHeader({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-10", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "select-none text-sm font-semibold", children: monthFormatter.format(currentMonth.toDate(timezone)) }),
    /* @__PURE__ */ jsx(
      IconButton,
      {
        size: "md",
  ...
  return /* @__PURE__ */ jsx("div", { className: "flex", children: [...new Array(7).keys()].map((index) => {
    ...
    return /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsx("div", { className: "absolute flex h-full w-full select-none items-center justify-center", children: weekday })
      },
      index
    );
  }) });
...
const Avatar = forwardRef(
  ({
    ...
    ) : fallback === "initials" && label ? /* @__PURE__ */ jsx("div", { className: "text-md flex h-full w-full items-center justify-center bg-warning font-semibold text-on-primary", children: label.slice(0, 1).toUpperCase() }) : /* @__PURE__ */ jsx("div", { className: "h-full w-full bg-alt dark:bg-chip", children: /* @__PURE__ */ jsx(
  ...
  return /* @__PURE__ */ jsxs(Dialog, { size: "xs", children: [
    ...
    /* @__PURE__ */ jsx(DialogBody, { padding: "px-14 pt-14 pb-4 max-h-288", children: /* @__PURE__ */ jsxs(
      Form,
      {
        ...
        children: [
          filter.description && /* @__PURE__ */ jsx("div", { className: "mb-14 text-xs text-muted", children: /* @__PURE__ */ jsx(Trans, { ...filter.description }) }),
          panel
        ]
      }
    ) }),
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        allowDownload && /* @__PURE__ */ jsx("div", { className: "mt-20 block text-center", children: /* @__PURE__ */ jsx(
          Button,
          {
            variant: "flat",
            color: "primary",
...
function WordDocumentFilePreview(props) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: clsx(className, "h-full w-full"), children: [
...
function FilePreviewContainer({
  ...
  return /* @__PURE__ */ jsxs(FilePreviewContext.Provider, { value: contextValue, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: clsx("relative flex-auto overflow-hidden", className), children: [
...
function Header({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex min-h-50 flex-shrink-0 items-center justify-between gap-20 border-b bg-paper px-10 text-sm text-muted", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex w-1/3 items-center justify-start gap-4", children: [
      actionsLeft,
      allowDownload ? downloadButton : void 0
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "flex w-1/3 flex-nowrap items-center justify-center gap-10 text-main", children: [
      /* @__PURE__ */ jsx(
        FileThumbnail,
        {
          file: activeEntry,
      ...
      /* @__PURE__ */ jsx("div", { className: "overflow-hidden overflow-ellipsis whitespace-nowrap", children: activeEntry.name })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "flex w-1/3 items-center justify-end gap-10 whitespace-nowrap", children: [
      !isMobile && /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "mx-20 h-24 w-1 bg-divider" })
      ] }),
...
export {
  DashboardLayoutContext as $,
  AddIcon as A,
  BackendFiltersUrlKey as B,
  ChipFieldFilterPanel as C,
  DashboardLayout as D,
  useNormalizedModels as E,
  FilterOperator as F,
  FILE_ENTRY_INDEX_FILTERS as G,
  FilePreviewDialog as H,
  InputFilterPanel as I,
  timestampFilter as J,
  KeyboardArrowRightIcon as K,
  LinkIcon as L,
  MoreVertIcon as M,
  NormalizedModelFilterPanel as N,
  FormNormalizedModelField as O,
  ArrowBackIcon as P,
  FormattedNumber as Q,
  InfoIcon as R,
  SelectFilterPanel as S,
  Table as T,
  USER_MODEL as U,
  useFileEntryUrls as V,
  FileThumbnail as W,
  TableContext as X,
  FilePreviewContainer as Y,
  FileEntryUrlsContext as Z,
  FILE_ENTRY_TYPE_FILTER as _,
  DashboardNavbar as a,
  activeInteraction as a0,
  isCtrlOrShiftPressed as a1,
  isCtrlKeyPressed as a2,
  encodeBackendFilters as a3,
  dragMonitors as a4,
  DateRangeIcon as a5,
  FormattedDateTimeRange as a6,
  useDateRangePickerState as a7,
  DateRangeComparePresets as a8,
  DateRangeDialog as a9,
  DateRangePresets as aa,
  ArrowDownwardIcon as ab,
  ArrowRightAltIcon as ac,
  ChevronLeftIcon as ad,
  MenuOpenIcon as ae,
  ...
  hasNextPage as h,
  FilterList as i,
  downloadFileFromUrl as j,
  FileDownloadIcon as k,
  Avatar as l,
  FormDatePicker as m,
  FormSwitch as n,
  ChipList as o,
  usePointerEvents as p,
  Switch as q,
  FormChipField as r,
  droppables as s,
  useDraggable as t,
  ...
  DeleteIcon as x,
  ChipField as y,
  useCurrentDateTime as z
};
//# sourceMappingURL=Info-96dcaa78.mjs.map
