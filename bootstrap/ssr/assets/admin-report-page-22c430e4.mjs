...
import { a as apiClient, a8 as ProgressCircle, T as Trans, b3 as shallowEqual, ae as getBootstrapData, ba as useSelectedLocale, l as useTrans, u as useSettings, br as useThemeSelector, m as message, bs as lazyLoader, f as createSvgIcon, k as DialogTrigger, e as IconButton, D as Dialog, h as DialogHeader, i as DialogBody, B as Button, a2 as createSvgIconFromTree, p as opacityAnimation, q as Skeleton, c as useIsMobileMediaQuery, ak as DateFormatPresets, r as StaticPageTitle } from "../server-entry.mjs";
...
import { P as ArrowBackIcon, Q as FormattedNumber, a5 as DateRangeIcon, a6 as FormattedDateTimeRange, a7 as useDateRangePickerState, a8 as DateRangeComparePresets, a9 as DateRangeDialog, aa as DateRangePresets } from "./Info-96dcaa78.mjs";
import { t as themeValueToHex, F as FormattedBytes } from "./admin-routes-115f1d5f.mjs";
...
function ChartLoadingIndicator() {
  return /* @__PURE__ */ jsxs("div", { className: "absolute mx-auto flex items-center gap-10 text-sm", children: [
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex gap-24", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "w-[170px]", children: [
            /* @__PURE__ */ jsx("div", { className: "max-h-[340px] w-full flex-initial overflow-y-auto text-sm", children: data.map((location) => /* @__PURE__ */ jsxs(
              "div",
              {
                className: clsx(
                ...
                children: [
                  /* @__PURE__ */ jsx("div", { className: "max-w-110 overflow-hidden overflow-ellipsis whitespace-nowrap", children: location.label }),
...
//# sourceMappingURL=admin-report-page-22c430e4.mjs.map
