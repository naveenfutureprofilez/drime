...
export function FileUploadWidget({
  ...
  return <div className="text-center">
      ...
      <div className={`border-2 border-dashed rounded-2xl p-4 transition-colors ${isDragOver ? 'border-blue-400 bg-blue-50' : 'border-gray-300 hover:border-gray-400'}`} onDragOver={handleDragOver} onDragLeave={handleDragLeave} onDrop={handleDrop}>
          ...
          <div className="bg-gray-50 rounded-xl p-6 mb-6">
            <h3 className="font-medium  mb-4">
              <Trans message="Selected files dsdfsdf" />
            </h3>
