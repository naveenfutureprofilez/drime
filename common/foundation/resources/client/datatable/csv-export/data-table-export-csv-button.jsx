...
import { useExportCsv } from '../requests/use-export-csv';
...
export function DataTableExportCsvButton({
  ...
  return <Fragment>
      <IconButton variant="outline" color="primary" size="sm" className="flex-shrink-0" disabled={exportCsv.isPending} onClick={() => {
      ...
      <DialogTrigger type="modal" isOpen={dialogIsOpen} onOpenChange={setDialogIsOpen}>
        <CsvExportInfoDialog />
      </DialogTrigger>
    </Fragment>;
}