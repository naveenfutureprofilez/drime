...
import { createdAtFilter, timestampFilter, updatedAtFilter } from '../../datatable/filters/timestamp-filters';
export const SubscriptionIndexPageFilters = [{
  key: 'ends_at',
  ...
  description: message('With which payment provider was subscription created'),
  defaultOperator: FilterOperator.eq
}, timestampFilter({
  key: 'renews_at',
