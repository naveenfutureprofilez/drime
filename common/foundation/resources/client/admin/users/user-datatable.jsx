...
export function UserDatatable() {
  ...
  return <Fragment>
      <DataTablePage endpoint="users" title={<Trans message="Users" />} filters={UserDatatableFilters} columns={filteredColumns} actions={<Actions />} queryParams={{
      with: 'subscriptions,bans,lastLogin'
    }} selectedActions={<DeleteSelectedItemsAction />} emptyStateMessage={<DataTableEmptyStateMessage image={teamSvg} title={<Trans message="No users have been created yet" />} filteringTitle={<Trans message="No matching users" />} />} />
    </Fragment>;
}
function Actions() {
  return <Fragment>
