...
import { updateUserPageTabs, UpdateUserPageTabs } from '@common/admin/users/update-user-page/update-user-page-tabs';
...
export function UpdateUserPage() {
  ...
  return <Fragment>
      ...
      {query.data?.user ? <PageContent user={query.data.user} /> : <PageStatus query={query} />}
    </Fragment>;
}
function PageContent({
  ...
  return <Fragment>
      <CrupdateResourceHeader wrapInContainer startActions={<IconButton elementType={Link} to=".." relative="path" size="sm" iconSize="md">
            <ArrowBackIcon />
          </IconButton>} endActions={<UpdateUserPageActions user={user} />}>
        <Trans message="Edit user" />
