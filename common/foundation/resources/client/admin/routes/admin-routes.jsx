...
export const adminRoutes = [{
  ...
  // LOCALIZATIONS
  {
    path: 'localizations',
    loader: () => authGuard({
      permission: 'localizations.update'
    }),
  ...
  // SETTINGS
  {
    ...
    children: [{
      ...
      path: 'general',
      lazy: () => lazyAdminRoute('GeneralSettings')
    }, {
      path: 'subscriptions',
      ...
      path: 'uploading',
      lazy: () => lazyAdminRoute('UploadingSettings')
    }, {
      path: 'outgoing-email',
      lazy: () => lazyAdminRoute('OutgoingEmailSettings')
    }, {
      path: 'cache',
      lazy: () => lazyAdminRoute('CacheSettings')
    }, {
      path: 'analytics',
      lazy: () => lazyAdminRoute('ReportsSettings')
    }, {
      path: 'logging',
      lazy: () => lazyAdminRoute('LoggingSettings')
    }, {
      path: 'queue',
      lazy: () => lazyAdminRoute('QueueSettings')
    }, {
      path: 'websockets',
      lazy: () => lazyAdminRoute('WebsocketSettings')
    }, {
      path: 'recaptcha',
      lazy: () => lazyAdminRoute('RecaptchaSettings')
    }, {
      path: 'gdpr',
      lazy: () => lazyAdminRoute('GdprSettings')
    }, ...appSettingsRoutes]
  },
  // LOGS
  {
    ...
    children: [{
      ...
      path: 'error',
      lazy: () => lazyAdminRoute('ErrorLogDatatable')
    }, {
      path: 'outgoing-email',
...
// APPEARANCE EDITOR
{
  ...
  children: [{
    index: true,
    lazy: () => lazyAdminRoute('SectionList')
  }, {
    path: 'general',
    lazy: () => lazyAdminRoute('GeneralSection')
  }, {
    path: 'seo-settings',
    lazy: () => lazyAdminRoute('SeoSection')
  }, {
    path: 'custom-code',
    lazy: () => lazyAdminRoute('CustomCodeSection')
  }, {
    path: 'themes',
    lazy: () => lazyAdminRoute('ThemeEditorForm'),
    children: [{
      index: true,
      lazy: () => lazyAdminRoute('ThemeList')
    }, {
      path: ':themeIndex',
  ...
  }, ...Object.values(AppAppearanceConfig.sections).flatMap(s => s.routes || [])]
}];