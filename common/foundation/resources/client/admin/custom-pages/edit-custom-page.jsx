...
export function EditCustomPage() {
  ...
  return query.data ? <Fragment>
      <PageMetaTags query={query} />
      <PageContent page={query.data.page} />
    </Fragment> : <div className="relative w-full h-full">
  ...
  return <Suspense fallback={<FullPageLoader />}>
      <ArticleBodyEditor initialContent={page.body}>
        {(content, editor) => <FileUploadProvider>
            <FormProvider {...form}>
              <ArticleEditorStickyHeader editor={editor} backLink="../.." isLoading={crupdatePage.isPending} onSave={handleSave} />
              <div className="mx-20">
