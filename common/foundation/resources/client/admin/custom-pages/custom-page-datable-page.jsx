...
export function CustomPageDatablePage() {
  ...
  return <DataTablePage endpoint="custom-pages" title={<Trans message="Custom pages" />} filters={filters} columns={CustomPageDatatableColumns} queryParams={{
    with: 'user'
  }} actions={<Actions />} selectedActions={<DeleteSelectedItemsAction />} emptyStateMessage={<DataTableEmptyStateMessage image={articlesSvg} title={<Trans message="No pages have been created yet" />} filteringTitle={<Trans message="No matching pages" />} />} />;
}
function Actions() {
  return <DataTableAddItemButton elementType={Link} to="new">
