...
import { useCreateCustomPage } from '@common/admin/custom-pages/requests/use-create-custom-page';
import { FullPageLoader } from '@ui/progress/full-page-loader';
const ArticleBodyEditor = React.lazy(() => import('@common/article-editor/article-body-editor'));
export function CreateCustomPage() {
  ...
  return <Suspense fallback={<FullPageLoader />}>
      <ArticleBodyEditor>
        {(content, editor) => <FileUploadProvider>
            <FormProvider {...form}>
              <ArticleEditorStickyHeader editor={editor} isLoading={createPage.isPending} onSave={handleSave} backLink="../" />
              <div className="mx-20">
