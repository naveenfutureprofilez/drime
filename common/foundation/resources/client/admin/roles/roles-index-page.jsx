...
export function RolesIndexPage() {
  return <DataTablePage endpoint="roles" title={<Trans message="Roles" />} columns={columnConfig} filters={RoleIndexPageFilters} actions={<Actions />} selectedActions={<DeleteSelectedItemsAction />} emptyStateMessage={<DataTableEmptyStateMessage image={teamSvg} title={<Trans message="No roles have been created yet" />} filteringTitle={<Trans message="No matching roles" />} />} />;
}
function Actions() {
  return <Fragment>
