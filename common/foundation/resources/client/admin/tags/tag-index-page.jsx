...
export function TagIndexPage() {
  ...
  return <DataTablePage endpoint="tags" title={<Trans message="Tags" />} columns={columnConfig} filters={filters} actions={<Actions />} selectedActions={<DeleteSelectedItemsAction />} emptyStateMessage={<DataTableEmptyStateMessage image={softwareEngineerSvg} title={<Trans message="No tags have been created yet" />} filteringTitle={<Trans message="No matching tags" />} />} />;
}
function Actions() {
  return <>
