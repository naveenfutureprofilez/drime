...
export function ForgotPasswordPage() {
  ...
  return <AuthLayout message={message}>
      ...
      sendEmail.mutate(payload);
        ...
        <FormTextField disabled={!!searchParamsEmail} className="mb-32" name="email" type="email" autoComplete="off" autoCorrect="off" spellCheck="false" label={<Trans message="Email" />} required />
        <Button className="block w-full" type="submit" variant="flat" color="primary" size="md" disabled={sendEmail.isPending}>
