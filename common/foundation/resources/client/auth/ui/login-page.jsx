...
export function LoginPage({
  ...
  const heading = isWorkspaceLogin ? <Trans values={{
    siteName: branding?.site_name
  }} message="To join your team on :siteName, login to your account" /> : <Trans message="Sign in to your account" />;
  ...
  return <AuthLayout heading={heading} message={message}>
      ...
      <SocialAuthSection dividerMessage={social?.compact_buttons ? <Trans message="Or sign in with" /> : <Trans message="OR" />} />
    </AuthLayout>;
}
