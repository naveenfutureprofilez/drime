...
export function TwoFactorDisabledStep({
  onEnabled
}) {
  ...
  return <TwoFactorStepperLayout title={<Trans message="You have not enabled two factor authentication." />} actions={<Button variant="flat" color="primary" disabled={isLoading} onClick={() => {
    withConfirmedPassword(() => {
