  ...
  return <div className="min-h-screen bg-alt">
      ...
      <div>
        <div className="container mx-auto px-24 py-24">
          ...
          {isLoading || !data ? <ProgressCircle className="my-80" aria-label="Loading user.." isIndeterminate /> : <div className="flex items-start gap-24">
              <AccountSettingsSidenav />
              <main className="flex-auto">
                {auth.accountSettingsPanels?.map(panel => <panel.component key={panel.id} user={data.user} />)}
