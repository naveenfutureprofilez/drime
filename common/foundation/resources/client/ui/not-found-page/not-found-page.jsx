...
export function NotFoundPage() {
  return <div className="flex flex-col-reverse items-center justify-center gap-64 px-16 py-96 md:gap-112 md:px-176 md:py-80 lg:flex-row lg:px-96 lg:py-96">
          ...
          <div className="absolute">
            <div className="relative z-10">
              ...
              <p className="my-16 text-main">
                <Trans message="Sorry about that! Please visit our homepage to get where you need
                to go." />
              </p>
              <Button className="my-8" elementType={Link} size="lg" to="/" variant="flat" color="primary">
