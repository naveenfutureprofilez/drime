...
export function ThemeProvider({
  ...
  let selectedTheme = selectedThemeId ? resolveTheme(selectedThemeId) : resolveTheme(settings.themes?.default_id ?? 0);
  if (!selectedTheme) {
  ...
  }, [allThemes, selectedTheme, setSelectedThemeId, resolveTheme, selectThemeTemporarily]);
  return <ThemeSelectorContext.Provider value={contextValue}>
      {children}
