...
export function NotificationsPage() {
  ...
  const markAsReadButton = <Button variant="outline" color="primary" size="xs" startIcon={<DoneAllIcon />} onClick={handleMarkAsRead} disabled={markAsRead.isPending || isLoading} className="ml-auto">
  ...
  return <Fragment>
      ...
      <div className="container mx-auto min-h-[1000px] p-16 md:p-24">
        <div className="mb-30 flex items-center gap-24">
          ...
          {notif.subs.integrated && <IconButton className="ml-auto text-muted" elementType={Link} to="/notifications/settings" target="_blank">
              <SettingsIcon />
            </IconButton>}
        </div>
        <PageContent />
...
function PageContent() {
  ...
  return <NotificationList className="rounded border" notifications={data.pagination.data} />;
}