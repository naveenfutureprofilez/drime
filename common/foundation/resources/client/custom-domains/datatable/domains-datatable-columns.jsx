...
export const domainsDatatableColumns = [{
  key: 'host',
  allowsSorting: true,
  ...
  body: domain => <div>
        <div className="flex items-center gap-6 whitespace-nowrap">
          ...
          <a className="block w-min overflow-hidden overflow-ellipsis font-semibold hover:underline" href={domain.host} target="_blank" rel="noreferrer" data-testid="host-name">
            {domain.host}
          </a>
        </div>
      </div>
  ...
  body: domain => {
    ...
    return <NameWithAvatar image={domain.user.image} label={domain.user.name} description={domain.user.email} />;
  }
}, {
  key: 'global',
  allowsSorting: true,
  ...
  body: domain => domain.updated_at ? <FormattedDate date={domain.updated_at} /> : ''
}, {
  key: 'actions',
